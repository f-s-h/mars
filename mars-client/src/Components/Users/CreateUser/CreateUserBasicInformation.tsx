...
interface CreateUserBasicInformationProps {
    newUser: User,
    setNewUser: (user: User) => void,
}

const CreateUserBasicInformation = (props: CreateUserBasicInformationProps) => {
...
export default CreateUserBasicInformation